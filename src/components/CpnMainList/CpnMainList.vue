  ...
  <cpn-block-card v-for="item in 8" :key="item">
    <div class="main-list-item">
      ...
      <div class="item-detail">
        <div class="item-detail-header">{{ '长恨歌' }}</div>
        ...
        <div class="item-detail-footer">
          <div class="footer-tags">
            <n-tag style="cursor: var(--cursor-normal)" type="warning">古诗</n-tag>
            <n-tag style="cursor: var(--cursor-normal)" type="success">白居易</n-tag>
          </div>
